#######################################################
# HelloID-Conn-Prov-Target-SalesForce-Apex-Rest-Enable
#
# Version: 1.0.0.1
#######################################################
...
if (-not($dryRun -eq $true)) {
    try {
        Write-Verbose "Enabling SalesForce account for '$($p.DisplayName)'"
        ...
        $logMessage = "Account for '$($p.DisplayName)' successfully enabled"
